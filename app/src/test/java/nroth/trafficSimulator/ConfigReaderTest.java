...
public class ConfigReaderTest {
	...
	public void testValidConfig() throws Exception {
		...
		Config config = reader.readConfigFile();

		assertNotNull(config);

		assertEquals(Integer.valueOf(10), config.X1());
		assertEquals(Integer.valueOf(12), config.X2());
		assertEquals(Integer.valueOf(5), config.S());
		assertEquals(Integer.valueOf(1), config.A1());
		assertEquals(Integer.valueOf(2), config.A2());
		assertEquals(Integer.valueOf(3), config.A3());
		assertEquals(Integer.valueOf(4), config.A4());
	}
